...
func (n *Combine) Up(ctx context.Context) error {
	...
	if _, err := InvokeWithoutEventTime(ctx, n.Fn.SetupFn(), nil, nil, nil, nil, nil, nil, nil); err != nil {
		return n.fail(err)
	}
...
func (n *Combine) mergeAccumulators(ctx context.Context, a, b interface{}) (interface{}, error) {
	...
	val, err := n.mergeInv.InvokeWithoutEventTime(ctx, in, nil, nil, nil, nil, nil, nil, b)
	if err != nil {
...
func (n *Combine) Down(ctx context.Context) error {
	...
	if _, err := InvokeWithoutEventTime(ctx, n.Fn.TeardownFn(), nil, nil, nil, nil, nil, nil, nil); err != nil {
...
func (n *Combine) newAccum(ctx context.Context, key interface{}) (interface{}, error) {
	...
	val, err := n.createAccumInv.InvokeWithoutEventTime(ctx, opt, nil, nil, nil, nil, nil, nil)
	if err != nil {
...
func (n *Combine) addInput(ctx context.Context, accum, key, value interface{}, timestamp typex.EventTime, first bool) (interface{}, error) {
	...
	val, err := n.addInputInv.InvokeWithoutEventTime(ctx, opt, nil, nil, nil, nil, nil, nil, v)
	if err != nil {
...
func (n *Combine) extract(ctx context.Context, accum interface{}) (interface{}, error) {
	...
	val, err := n.extractOutputInv.InvokeWithoutEventTime(ctx, nil, nil, nil, nil, nil, nil, nil, accum)
	if err != nil {
